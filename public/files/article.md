...
* Я использую такую схему
    ...
    * БД catalog_"идентификатор клиента" (импорт из catalog_dev) - продуктивная
* Общие и региональные справочники
    ...
    * БД region_"идентификатор клиента региона" (импорт из region_"идентификатор региона") - продуктивная
...
В следующей таблице результаты тестирования создания записей. Тестировалось на MacBook Pro Mid 2014 (MGX82).

| Свойства                                       | 100 записей (сек.) | 1000 записей (сек.) | Записей в сек. |
|------------------------------------------------|--------------------|---------------------|----------------|
| Кол-во: 1, Число: 1                            | 0.5                | 4.5                 | 220            |
| Кол-во: 1, Строка: 1                           | 0.5                | 5.7                 | 174            |
| Кол-во: 1, Дата: 1                             | 0.5                | 5.9                 | 170            |
| Кол-во: 3, Число: 1, Строка: 1, Дата: 1        | 0.5                | 5.9                 | 170            |
| Кол-во: 10, Число: 10                          | 0.5                | 6.2                 | 162            |
| Кол-во: 10, Строка: 10                         | 0.5                | 5.7                 | 175            |
| Кол-во: 10, Дата: 10                           | 0.6                | 6.3                 | 160            |
| Кол-во: 30, Число: 10, Строка: 10, Дата: 10    | 1.0                | 9.8                 | 102            |
| Кол-во: 100 Число: 100                         | 2.3                | 23.4                | 43             |
| Кол-во: 100 Строка: 100                        | 2.4                | 23.7                | 42             |
| Кол-во: 100 Дата: 100                          | 2.3                | 24.2                | 41             |
...
Лицензия платформы MIT. Используется на продуктивных серверах и поддерживаться будет длительное время. Планируется разработка дополнительных пакетов по аналитике и другим нужным направлениям.  
Спасибо за внимание.
